...
<div class="row">
    <div class="col-lg-9">
        <div class="card-title">
            ...
            <div class="card-body">
                <img class="img-fluid" src=" IMG_20200229_105612.jpg" width="250" height="250" style="float: left">
                <div class="card-body" style="float: left">
                    <h3><a class="card-text" href=""> <i class="fa fa-email"></i>Abdullah al tushar</a> </h3>
