...
//            convert jpg
    ...
    if(in_array( $filecheck, $fileextstored)){
        ...
        $sql="INSERT INTO `product`( `name`, `cat_id`, `cat_name`, `model`, `band`, `warranty`, `display`, `processor`, `ram`, `storage`, `gpu`, `keyboard`, `os`, `weight`, `special_price`, `regular_price`, `description`, `image`, `wifi`) VALUES ('$product_name','$cat_id','$cat_name','$model','$band','$warranty','$display','$processor','$ram','$Storage','$gpu','$keyboard','$os','$weight','$special_price','$regular_price','$description','$destinationfile','$wifi')";
